...
public class BatteryView extends View {
    ...
    private void drawHorizontalBattery(Canvas canvas) {
        ...
        canvas.drawRoundRect(r1,4.0f,4.0f, paint);
        paint.setStrokeWidth(0);
        paint.setStyle(Paint.Style.FILL);

        float offset = (width - strokeWidth * 2) * 100 / 100.f;
        RectF r2 = new RectF(strokeWidth, strokeWidth, offset, height - strokeWidth);
        paint.setColor(Color.WHITE);
        canvas.drawRoundRect(r2,4.0f,4.0f, paint);
        //画电池内矩形电量
        offset = (width - strokeWidth * 2) * mPower / 100.f;
        r2 = new RectF(strokeWidth, strokeWidth, offset, height - strokeWidth);
        //根据电池电量决定电池内矩形电量颜色
//        if (mPower < 30) {
