...
public class ObservVoltDetonattor implements Observer<Integer> {
    Context context;
    FragmentVolt frVolt;
    ...
    public ObservVoltDetonattor(Context context, FragmentVolt frVolt, FragmentManager fragmentManager) {
    ...
    public void onChanged(@Nullable Integer integer) {
        switch (integer) {
            case 0:
                ...
                if (dataViewModel.checkVolt == 1) {
                    if (vData[1] < 12.1f) {
                        InfoDialog infoDialog = new InfoDialog();
                        infoDialog.setTitle("电压故障");
                        infoDialog.setMessage("电压过低，禁止起爆!");
                        ...
                        infoDialog.setOnButtonClickListener(new InfoDialog.OnButtonClickListener() {
                            ...
                            public void onButtonClick(int index, String str) {
                                ...
                                dataViewModel.exit.postValue(2000);
                            }
                        });
