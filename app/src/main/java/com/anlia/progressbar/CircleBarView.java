...
public class CircleBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        bgColor = typedArray.getColor(R.styleable.CircleBarView_bg_color, Color.LTGRAY);
        ...
        barWidth = typedArray.getDimension(R.styleable.CircleBarView_bar_width, DpOrPxUtils.dip2px(context, 14));
        typedArray.recycle();
